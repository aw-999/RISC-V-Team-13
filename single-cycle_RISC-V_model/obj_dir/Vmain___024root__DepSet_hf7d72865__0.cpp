...
void Vmain___024root___eval_triggers__act(Vmain___024root* vlSelf) {
    ...
    // Body
    vlSelfRef.__VactTriggered.set(0U, (vlSelfRef.main__DOT__DOutAlu 
                                       != vlSelfRef.__Vtrigprevexpr___TOP__main__DOT__DOutAlu__1));
    vlSelfRef.__VactTriggered.set(1U, ((IData)(vlSelfRef.main__DOT__flag) 
                                       != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__main__DOT__flag__1)));
