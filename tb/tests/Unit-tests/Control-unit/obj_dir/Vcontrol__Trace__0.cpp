...
void Vcontrol___024root__trace_chg_sub_0(Vcontrol___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+1,(vlSelf->ZeroFlag));
    bufp->chgBit(oldp+2,(vlSelf->NegativeFlag));
    bufp->chgBit(oldp+3,(vlSelf->UnsignedLess));
    bufp->chgCData(oldp+4,(vlSelf->funct3),3);
    bufp->chgCData(oldp+5,(vlSelf->PCSrc),2);
    ...
    bufp->chgCData(oldp+11,(vlSelf->ALUop),3);
}
