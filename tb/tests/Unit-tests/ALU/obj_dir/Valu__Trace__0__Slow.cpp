...
VL_ATTR_COLD void Valu___024root__trace_init_sub__TOP__0(Valu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBus(c+1,"ALUctrl", false,-1, 3,0);
    tracep->declBus(c+2,"ALUflag", false,-1, 2,0);
    tracep->declBus(c+3,"SrcA", false,-1, 31,0);
    tracep->declBus(c+4,"SrcB", false,-1, 31,0);
    tracep->declBus(c+5,"ALUresult", false,-1, 31,0);
    tracep->declBit(c+6,"flag", false,-1);
    tracep->declBit(c+7,"nflag", false,-1);
    tracep->pushNamePrefix("alu ");
    tracep->declBus(c+8,"W", false,-1, 31,0);
    tracep->declBus(c+1,"ALUctrl", false,-1, 3,0);
    tracep->declBus(c+2,"ALUflag", false,-1, 2,0);
    tracep->declBus(c+3,"SrcA", false,-1, 31,0);
    tracep->declBus(c+4,"SrcB", false,-1, 31,0);
...
VL_ATTR_COLD void Valu___024root__trace_full_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullCData(oldp+1,(vlSelf->ALUctrl),4);
    bufp->fullCData(oldp+2,(vlSelf->ALUflag),3);
    bufp->fullIData(oldp+3,(vlSelf->SrcA),32);
    bufp->fullIData(oldp+4,(vlSelf->SrcB),32);
    bufp->fullIData(oldp+5,(vlSelf->ALUresult),32);
    bufp->fullBit(oldp+6,(vlSelf->flag));
    bufp->fullBit(oldp+7,(vlSelf->nflag));
