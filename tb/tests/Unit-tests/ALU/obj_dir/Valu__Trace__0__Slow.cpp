...
VL_ATTR_COLD void Valu___024root__trace_init_sub__TOP__0(Valu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+5,"ZeroFlag", false,-1);
    tracep->declBit(c+6,"NegativeFlag", false,-1);
    tracep->declBit(c+7,"UnsignedLess", false,-1);
...
VL_ATTR_COLD void Valu___024root__trace_full_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+5,(vlSelf->ZeroFlag));
    bufp->fullBit(oldp+6,(vlSelf->NegativeFlag));
    bufp->fullBit(oldp+7,(vlSelf->UnsignedLess));
