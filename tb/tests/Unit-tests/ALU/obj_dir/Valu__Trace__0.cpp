...
void Valu___024root__trace_chg_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgCData(oldp+0,(vlSelf->ALUctrl),4);
    bufp->chgCData(oldp+1,(vlSelf->ALUflag),3);
    bufp->chgIData(oldp+2,(vlSelf->SrcA),32);
    bufp->chgIData(oldp+3,(vlSelf->SrcB),32);
    bufp->chgIData(oldp+4,(vlSelf->ALUresult),32);
    bufp->chgBit(oldp+5,(vlSelf->flag));
    bufp->chgBit(oldp+6,(vlSelf->nflag));
}
